  ...
  return (
    <div className="p-3 md:p-8 max-w-5xl mx-auto">
      <div className="flex items-center gap-2 md:gap-3 mb-4">
        ...
        <h1 className="text-xl md:text-2xl font-bold text-gray-800">📝 Create Order</h1>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              className="border rounded-lg p-2 md:p-3 w-full text-sm md:text-base"
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <button
                  ...
                  className="bg-gray-500 hover:bg-gray-600 text-white px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm flex-1 sm:flex-none"
                >
                  Reset
                </button>
                <button
                  type="button"
                  onClick={addItemRow}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-3 md:px-4 py-2 rounded-lg text-xs md:text-sm flex-1 sm:flex-none"
                >
                  + Add Item
                </button>
              </div>
